...
import sys
from pyg_dataset_neighborhood import NetlistDataset
...
filepath = f"../results/seed1/{timestamp}__{num_epochs}_{num_layer}_{num_dim}_{vn}_{prediction}_neighborhood.csv"
